...
#define USB_DEVICE_ID_APPLE_WELLSPRING6A_ANSI	0x0248
#define USB_DEVICE_ID_APPLE_WELLSPRING6A_ISO	0x0249
#define USB_DEVICE_ID_APPLE_WELLSPRING6A_JIS	0x024a
